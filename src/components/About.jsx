    ...
    return (
        ...
        <div class="about-information2">
            ...
            <div style={{width:"400px"}}>
                ...
                <br/>
                <button class="button"><a href="https://drive.google.com/file/d/1DsafvcFMlmIAXjrP7ItqMx-opTcY2oo6/view?usp=sharing" download={"Harshul Resume"}>Get Resume</a></button>
            </div>
