    ...
    return (
        ...
        <div class="about-information2">
            ...
            <div style={{width:"400px"}}>
                ...
                <br/>
                <button class="button"><a href="https://drive.google.com/file/d/1xpdQiqxSX-OZRKyrDQXieVtnrFU4a2gF/view?usp=sharing" download={"Harshul Resume"}>Get Resume</a></button>
            </div>
